...
type colors = 'blue' | 'red' | 'orange' | 'white'
...
const initialState: ResourcesState = {
  2: {
    brick: { blue: 0, red: 0, orange: 0, white: 0 },
    grain: { blue: 0, red: 0, orange: 0, white: 0 },
    lumber: { blue: 0, red: 0, orange: 0, white: 0 },
    ore: { blue: 0, red: 0, orange: 0, white: 0 },
    wool: { blue: 0, red: 0, orange: 0, white: 0 },
  },
  3: {
    brick: { blue: 0, red: 0, orange: 0, white: 0 },
    grain: { blue: 0, red: 0, orange: 0, white: 0 },
